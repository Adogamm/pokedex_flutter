...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        home: ChipName(this.tipo)
    );
  }
}
class ChipName extends StatefulWidget {
  ChipName(this.tipo);
  String tipo;
//  final String tipo;
  ...
  @override
  _ChipName createState() => _ChipName(this.tipo);
}

class _ChipName extends State<ChipName> {
  _ChipName(this.tipo);
  String tipo;
  var url =
      ...
      body: pokeHub == null
        ...
        builder: (context, orientation) {
          return GridView.count(
            ...
            (poke.name.toString()
                .toLowerCase()
                .contains(this.tipo.toLowerCase().toString())
            ))
                .map((Pokemon poke) =>
                Padding(
